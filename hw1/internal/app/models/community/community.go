...
func (us *Community) SearchComms(ctx context.Context, s string) (chan Community, error) {
...
func (us *Communities) Read(ctx context.Context, uid uuid.UUID) (*Communities, error) {
